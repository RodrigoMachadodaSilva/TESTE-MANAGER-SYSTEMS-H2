...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<?> handleEntidadeNaoEncontrada(LoginInvalidoException ex, WebRequest request) {
	...
	public ResponseEntity<?> handleEntidadeEmUso(TokenInvalidoException ex, WebRequest request) {
	...
	public ResponseEntity<?> handleNegocio(ToKenExpiradoException ex, WebRequest request) {
	...
	public ResponseEntity<?> handleNegocio(UsuarioNaoAutorizadoException ex, WebRequest request) {
